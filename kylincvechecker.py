...
notaffect = "/Users/wangli/cvechecker/notaffect.md"
blacklist = ["wifi", "drm", "ALSA", "Bluetooth", "smb", "IB", "RDMA", "cifs", "staging", "ASoC", "io_uring", "vxlan", "btrfs", "media", "jfs", "nilfs", "soundwire", "ext2", "iavf", "codel", "atm", "tipc", "comedi", "xen", "f2fs", "appletalk", "hfs", "fbdev", "mac_hid"]
def parse_data(data):
    maybe_affect = False
    pkg_line = data['name']
    pkg_rhel7_affected = "--"
